...
@section('title', 'Ajouter une catégorie chambre')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-fill card-primary">
                <div class="header">
                    <h3 class="title">Ajouter une catégorie</h3>
                </div>
                    ...
                    <form method="POST" action="{{ route('room_types.store') }}">
                        ...
                        <div class="row">
                            <div class="col-md-12{{ $errors->has('base_price') ? ' has-error' : '' }}">
                                ...
                                <input id="base_price" type="number" min="0" class="form-control border-input" name="base_price" value="{{ old('base_price') }}" required autofocus>
                        ...
                        <div class="row">
                            <div class="col-md-12{{ $errors->has('description') ? ' has-error' : '' }}">
                                ...
                                <textarea id="description" class="form-control border-input" name="description" id="description" rows="5" autofocus>{{ old('description') }}</textarea>
