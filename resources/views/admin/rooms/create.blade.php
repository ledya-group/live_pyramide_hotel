...
@section('title', "Catégorie {$room_type_id} - Ajouter une chambre")
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-fill card-primary">
                <div class="header">
                    <h3 class="title">Ajouter une chambre</h3>
                </div>
                    ...
                    <form method="POST" action="{{ route('rooms.store') }}">
                            ...
                            <div class="col-md-12{{ $errors->has('room_type_id') ? ' has-error' : '' }}">
                                ...
                                <select name="room_type_id" class="form-control border-input">
                                    ...
                                    <option value="{{ $room_type->id }}"
                                            {{ ($room_type->id == $room_type_id) ? "selected" : "" }}
                        ...
                        <div class="row">
                            <div class="col-md-12{{ $errors->has('description') ? ' has-error' : '' }}">
                                ...
                                <textarea id="description" class="form-control border-input" name="description" id="description" rows="5" autofocus>
                                    {{ old('description') }}
                                </textarea>
